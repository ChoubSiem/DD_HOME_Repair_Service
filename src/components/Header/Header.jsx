...
const Header = () => {
    return (
        <section className="bg-green-500 min-h-[24rem] py-6 px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Logo */}
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full justify-center mt-4">
                    <div className="relative w-full md:w-80">
                        <input
                            type="text"
                            placeholder="Search"
                            className="w-full bg-white h-10 rounded-md pl-10 pr-3 text-black border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-400"
                        />
